...
#Loading libraries
library(pacman)
p_load(modelr,lmerTest,ggplot2,dplyr,tidyverse,MuMIn,pacman,stringr,tidyverse,plyr,caret,Metrics,groupdata2,simr)


#Loading data
train_data=read.csv("df_train_original.csv",sep=",")
train_data=select(train_data,-c(X.1))
...
#Adding an interaction between Visit and Diagnosis
...
fixef(MLU_model)["Visit"] = 5
fixef(MLU_model)["DiagnosisTD"] = 5
fixef(MLU_model)["verbalIQ"] = 10
fixef(MLU_model)["Vst:DgnssTD"] = 5

powerCurve_visit = powerCurve(MLU_model,fixed("Visit"),along="Child.ID", nsim = 10)
powerCurve_Diagnosis = powerCurve(MLU_model, fixed("Diagnosis"),along = "Child.ID", nsim = 10)
powerCurve_verbalIQ = powerCurve(MLU_model, fixed("verbalIQ"),along = "Child.ID", nsim = 10)
